...
var (
	...
	ErrServerError = errors.New("ErrServerError") // Ошибка: ошибка сервера...

	ErrProductNotWeightBased = errors.New("ErrProductNotWeightBased") // Ошибка: продукт не основан на весе...

	// Ошибка, если пытаются удалить оплаченный заказ или товар из него
	ErrCannotDeletePaidOrder     = errors.New("ErrCannotDeletePaidOrder")     // Ошибка: нельзя удалить оплаченный заказ...
	ErrCannotDeletePaidOrderItem = errors.New("ErrCannotDeletePaidOrderItem") // Ошибка: нельзя удалить товар из оплаченного заказа...
	ErrCannotAddToPaidOrder      = errors.New("ErrCannotAddToPaidOrder")      // Ошибка: нельзя добавлять в оплаченный заказ
)
