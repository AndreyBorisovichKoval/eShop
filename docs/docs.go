    ...
    "definitions": {
        ...
        "models.User": {
            ...
            "properties": {
                ...
                "updated_at": {
                    "description": "UpdatedAt *time.Time ` + "`" + `gorm:\"-\" json:\"updated_at\"` + "`" + `                         // Время последнего обновления записи.",
                    "type": "string"
                },
                "username": {
