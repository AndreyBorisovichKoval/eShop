...
type Supplier struct {
	...
	Title string `gorm:"size:255;not null;unique" json:"title"` // Название или имя поставщика (уникальное)...
	Email string `gorm:"size:255;unique" json:"email"`          // Электронная почта поставщика (уникальная)...
