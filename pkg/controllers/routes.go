...
func InitRoutes() *gin.Engine {
	...
	productG := router.Group("/products", checkUserAuthentication, checkUserBlocked())
	{
		...
		productG.PATCH("/:id/restore", RestoreProductByID)     // Маршрут для восстановления удаленного продукта...
		productG.DELETE("/:id/soft", SoftDeleteProductByID)    // Маршрут для мягкого удаления продукта...
