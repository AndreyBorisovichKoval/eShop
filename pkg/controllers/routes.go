...
func InitRoutes() *gin.Engine {
	...
	userChangePswG := router.Group("/change-passowrd", checkUserAuthentication)
	{
		userChangePswG.PATCH("", ChangeOwnPassword) // Обновление пароля текущего пользователя...
	}

	// userG := router.Group("/users")
	userG := router.Group("/users", checkUserAuthentication, checkUserBlocked, CheckPasswordResetRequired)
	{
